...
<body>
    ...
    echo '<td><a href="delete_journal.php?id=' . $row['entry_id'] . '" onclick="return confirm(\'Are you sure?\');">
              <i class="fa fa-trash-o" style="font-weight: 100; font-size: 14px; color: #999;"></i>
          </a></td>';
    echo '</tr>';
}
                        echo '</table>';
